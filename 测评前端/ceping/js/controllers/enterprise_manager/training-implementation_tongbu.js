 ...
 * @author xzy
 * @datetime 2012-8-11
 * @description training-implementation_tongbu.js
 */
	...
	var list = Ambow.create('Ambow.view.ListView',{
			...
			checkboxs:true,
	 		columns: [/*{
	            ...
	            dataIndex: 'a',
	            render:function(dt,row){
	            	return '<a href="#" class="tabico_edit" title="编辑">编辑</a><a href="javascript:" class="tabico_del trdel"  title="删除">删除</a><span title="更多操作" class="more_action"><i>更多操作</i><ul class="more_action_list"><li class="arrowli"></li><li><a href="#" class="updatepaper" title="进入课程">进入课程</a></li><li><a href="#" class="updatepaper" title="导出学习记录">导出学习记录</a></li><Li><a href="#">查看反馈结果</a></Li></ul></span>';
	            }
	        }]
	  	});
	  	list.render();
