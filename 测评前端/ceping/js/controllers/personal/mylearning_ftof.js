			...
			checkboxs:true,
	 		columns: [/*{
				...
				},
				{
					...
					dataIndex: 'a',
					render:function(dt,row){
						return '<a class="icon_download" title="下载培训资料" href="#">下载培训资料</a><a class="icon_question" title="填写调查问卷" href="#">填写调查问卷</a><a class="icon_cancel overlay_cancel" title="退选" href="overlay_cancel.html">退选</a>';
					}
	        }]
	  	});
	  	list.render();
