...
{
	var unit_id     = "324202";
	var client_ip   = "121.22.1.169";
	var server_time = "1317026404";
	var verify_code = "36304282";
	var type        = "0";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	document.write( "<a href=\"http://"+icon_link_host+"/report.html?unit_id="+unit_id+"\" target=\"_blank\">LinezingStat</a>" );
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/324202/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
