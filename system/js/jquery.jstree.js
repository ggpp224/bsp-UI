	...
	$(function() {
		...
		var u = navigator.userAgent.toLowerCase(),
			...
			css_string = '' + 
				...
				'.jstree ins { display:inline-block; text-decoration:none; width:14px; height:18px; margin:0 0 0 0; padding:0; } ' + 
	...
	$.jstree.plugin("checkbox", {
		...
		_fn : {
			...
			change_state : function (obj, state) {
				...
				if(state) 
				{ 
					if(this._get_settings().checkbox.checkboxsetting==2){
						obj.removeClass("jstree-checked jstree-undetermined").addClass("jstree-unchecked");
					}else if(this._get_settings().checkbox.checkboxsetting==3){
				...
				obj.parentsUntil(".jstree", "li").each(function () {
					var $this = $(this);
					if(th._get_settings().checkboxsetting==1){
						if(state) {
					...
					}else if(th._get_settings().checkbox.checkboxsetting==4){
//						if(state) {
//							if($this.children("ul").children(".jstree-checked, .jstree-undetermined").length) {
//								$this.parentsUntil(".jstree", "li").andSelf().removeClass("jstree-checked jstree-unchecked").addClass("jstree-undetermined");
//								return false;
