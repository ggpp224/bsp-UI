...
jQuery(function($) {
	...
	// Private Variables
	// -------------------------------------------------------
	var titleHeight = 36;//The height of modal window's title
	...
	$.fn.nyroModal.settings = {
		...
		windowResize: true, // 是否随窗口大小自适应伸缩
		...
		closeButton: '<a href="#" class="overlayClose" id="closeBut" title="关闭">Close</a>', // Adding automaticly as the first child of #nyroModalWrapper

		title: null, // Modal title
		titleFromIframe:false, // When using iframe in the same domain, try to get the title from it

		openSelector: '.nyroModal', // selector for open a new modal. will be used to parse automaticly at page loading
		closeSelector: '.overlayClose', // selector to close the modal

		contentLoading: '<a href="#" class="nyroModalClose">Cancel</a>', // Loading div content

		errorClass: 'error', // CSS Error class added to the loading div in case of error
		contentError: '页面没有找到。<br />请再仔细核对路径。<br /><a href="#" class="nyroModalClose overlayClose">关闭</a>', // Content placed in the loading div in case of error
		...
		if (from) {
			...
			if (currentSettings.type == 'form') {
				...
				$('iframe', modal.tmp).eq(0)
					.css({
						width: '100%',
						height: currentSettings.title ? (currentSettings.height - titleHeight) : ($.support.boxModel? '99%' : '100%')
					})
					.load(iframeLoaded);
				modal.dataReady = true;
				showModal();
	...
	// Set the modal Title
	function setTitle() {
		var title = $('h2#nyroModalTitle', modal.content);
		if (title.length)
			title.text(currentSettings.title);
		else
			modal.content.prepend('<h2 id="nyroModalTitle">'+currentSettings.title+'</h2>');
		   // modal.content
	}
	...
	function fillContent() {
		...
		if (!currentSettings.modal)
			modal.content.prepend(currentSettings.closeButton);
...
/*	function galleryCounts(nb, total, elts, settings) {
	...
	function showBackground(elts, settings, callback) {
		elts.bg.css({opacity:0}).fadeTo(300, 0.50, callback);
	}
		...
		elts.loading
			.animate({
				...
				marginTop: settings.marginTop+'px'
					...
					elts.loading.fadeOut(2, function() {
						elts.loading.hide();
						callback();
					});
				}, duration: 2});
